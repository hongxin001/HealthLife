...
public class ControlFragment extends Fragment{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        WifiManager manager = (WifiManager)this.getActivity().getSystemService((Context.WIFI_SERVICE));
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		View v = (View)inflater.inflate(R.layout.fragment_control, container, false);
			...
			public void onClick(View v) {
                ...
                executorService.submit(new Runnable() {
                    ...
                    public void run() {
                        ...
                        line.setControlName(ControlNameEnum.CONTROL).setAirConditionState(AirConditionStateEnum.CONTROL_SEVEN).setUsername("00068").setPassword("1994");
